                    ...
                    <div key={exercise.id}>
                      ...
                      {exercise.prescribed_sets.map((set, setIndex) => (
                        <div key={set.id}>
                          <p
                            className={
                              styles["workout-profile-prescribed-info"]
                            }
                          >
                            <b>Prescribed weight:</b> {set.weight} Kgs
                          </p>
                  ...
                  {day.exercises.map((exercise, exerciseIndex) => (
                    <div key={exercise.id}>
                      ...
                      <input
                        ...
                        name="weight"
                        value={
                          completedWeight[`${dayIndex}-${exerciseIndex}`] || ""
                        }
                        onChange={(e) => {
                      ...
                      <input
                        ...
                        name="reps"
                        value={
                          completedReps[`${dayIndex}-${exerciseIndex}`] || ""
                        }
                        onChange={(e) => {
                          const key = `${dayIndex}-${exerciseIndex}`;
                      ...
                      {exercise.completed_sets.map((completedSet, index) => (
                        <div key={index}>
                          <p
                            className={styles["workout-profile-completed-set"]}
                          >
